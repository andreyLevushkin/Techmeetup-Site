...
public class AppModule {
	public static void bind(ServiceBinder binder) {
		...
		binder.bind(ContentService.class, ContentServiceImpl.class);
		binder.bind(ImageService.class, ImageServiceImpl.class);
		binder.bind(AccessControlDispatcher.class).withId(
				"AccessControlDispatcher");
		binder.bind(TagCache.class, TagCacheImpl.class);
		binder.bind(TagService.class, TagServiceImpl.class);
		binder.bind(NotificationService.class, NotificationServiceImpl.class);
		binder.bind(PasswordService.class, PasswordServiceImpl.class);
		binder.bind(InputSanitizer.class, InputSanitizerImpl.class);
	}
